...
public class TechChallengeDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public TechChallengeDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
